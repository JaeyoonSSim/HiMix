...
from ..utils.model_himix import HiMix
from monai.losses import DiceCELoss
from torchmetrics import Accuracy,Dice
from torchmetrics.classification import BinaryJaccardIndex

class HiMixWrapper(pl.LightningModule):
    def __init__(self, args):
        super(HiMixWrapper, self).__init__()
        
        self.model = HiMix(args.bert_type, args.vision_type, args.project_dim)
        self.lr = args.lr
        self.history = {}
